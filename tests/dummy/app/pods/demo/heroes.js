/**
 * Some hero data we can display in various tables
 */
...
const heroes = [
  ...
  {
    name: 'Hawkgirl',
    realName: 'Kendra Munoz-Saunders',
    teamAffiliatinos: ['JLA'],
    universe: 'DC'
  },
  {
  ...
  },
  {
    ...
    teamAffiliatinos: ['Avengers', 'X-Men'],
    universe: 'Marvel'
  },
  {
    name: 'Falcon',
    realName: 'Samuel "Snap" Thomas Wilson',
    teamAffiliatinos: ['Avengers'],
    universe: 'Marvel'
  },
  {
